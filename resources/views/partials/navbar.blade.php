    ...
    <div class="container mx-auto px-4 py-4">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:flex lg:items-center space-x-1">
                ...
                <a href="/courses" class="px-4 py-2 rounded-lg hover:bg-blue-800 hover:text-white transition duration-150 ease-in-out {{ request()->routeIs('courses.*') ? 'bg-blue-800 text-white font-medium' : 'text-blue-100' }}">
                    <div class="flex items-center space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
       ...
       @guest()
                 <a href="/login" class="px-4 py-2 rounded-lg hover:bg-blue-800 hover:text-white transition duration-150 ease-in-out {{ request()->routeIs('courses.*') ? 'bg-blue-800 text-white font-medium' : 'text-blue-100' }}">
                    <div class="flex items-center space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
                 ...
                 <a href="/register" class="px-4 py-2 rounded-lg hover:bg-blue-800 hover:text-white transition duration-150 ease-in-out {{ request()->routeIs('courses.*') ? 'bg-blue-800 text-white font-medium' : 'text-blue-100' }}">
                    <div class="flex items-center space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
        ...
        @endguest
                        ...
                        <form method="POST" action="/logout">
                                <button class="px-4 py-2 rounded-lg hover:bg-blue-800 hover:text-white transition duration-150 ease-in-out {{ request()->routeIs('courses.*') ? 'bg-blue-800 text-white font-medium' : 'text-blue-100' }}"> 
                                @csrf
                                    Log out
                                </button>
